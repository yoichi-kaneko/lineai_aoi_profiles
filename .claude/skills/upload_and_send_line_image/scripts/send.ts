...
async function main() {
  ...
  if (!originalContentUrl || !previewImageUrl) {
    console.error("使用方法: npx tsx scripts/send.ts <originalContentUrl> <previewImageUrl>");
    console.error('例: npx tsx scripts/send.ts "https://example.com/image.jpg" "https://example.com/preview.jpg"');
    process.exit(1);
  }
